...
class CustomScrollbar(tk.Canvas):
    def __init__(self, parent, **kwargs):
        ...
        self.fg = kwargs.pop("fg", "darkgray")
        self.bg = kwargs.pop("bg", None)
        kwargs.pop("bd", None)
        tk.Canvas.__init__(self, parent, bd=5, bg=self.bg, highlightthickness=0, **kwargs)
        ...
        # in the 'set' method\
        self.old_y = 0
        self.create_rectangle(0, 0, 1, 1, fill=kwargs["fg"], outline=self.fg, tags=("thumb",))
